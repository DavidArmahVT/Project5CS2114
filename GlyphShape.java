...
public class GlyphShape {
    ...
    public GlyphShape(
        ...
        width = (int)((window.getGraphPanelWidth()
            - DisplayWindow.LEGEND_WIDTH) / 3 - 2
        ...
        // text occupies
        barHeight = (int)((height - 2 * DisplayWindow.TEXT_HEIGHT - 3
            * DisplayWindow.TEXT_SPACING) / 4);
    ...
    public void draw() {
        ...
        artist.moveTo((int)(x0 - artist.getWidth() / 2), y0
            + DisplayWindow.TEXT_HEIGHT + DisplayWindow.TEXT_SPACING);
        ...
        for (int i = 0; i < 4; i++) {
            ...
            shape.moveTo((int)(x0 - axis.getWidth() / 2 - shape.getWidth()), y0
                + 2 * DisplayWindow.TEXT_HEIGHT + 2
                    * DisplayWindow.TEXT_SPACING + i * barHeight);
        }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            shape.moveTo((int)(x0 + axis.getWidth() / 2), y0 + 2
                * DisplayWindow.TEXT_HEIGHT + 2 * DisplayWindow.TEXT_SPACING
                + i * barHeight);
        }
