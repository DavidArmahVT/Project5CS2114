...
/**
 * Recycled From Lab 10, DoublyLinkedList
 */
/**
...
public class DLList<E> implements Iterable<E> {
    ...
    private class DLLIterator<A> implements Iterator<E> {
        ...
        public void remove() {
            if (wasNextCalled)
            {
                Node<E> nodeToBeRemoved = nextNode.previous;
                nodeToBeRemoved.previous().setNext(nodeToBeRemoved.next());
                nodeToBeRemoved.next().setPrevious(nodeToBeRemoved.previous());
                size--;
                wasNextCalled = false;
            ...
            {
                throw new IllegalStateException("nananana");
            }
        }
    }
    ...
    private class RDLListIterator<A> implements Iterator<E> {
        ...
        public E next() {
            ...
            {
                throw new NoSuchElementException("nanananana");
            }
        }
        ...
        public void remove() {
            if (wasNextCalled)
            {
                Node<E> nodeToBeRemoved = nextNode.next();
                nodeToBeRemoved.previous().setNext(nodeToBeRemoved.next());
                nodeToBeRemoved.next().setPrevious(nodeToBeRemoved.previous());
                size--;
                wasNextCalled = false;
