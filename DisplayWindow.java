...
public class DisplayWindow {
    ...
    private LegendShape legend;
    private int currentPage;
    private SortEnums currentCategory;
    private SortEnums currentSort;
    ...
    /**
     * Constructor for DisplayWindow. creates buttons and displays the default
     ...
     */
    public DisplayWindow(SongList songs, SinglyLinkedList<Student> students) {
        this.songs = songs;
        this.students = students;
        window = new Window("cam1111 jhayward farinaa");
        currentPage = 0;
        currentCategory = SortEnums.HOBBY;
        currentSort = SortEnums.TITLE;
    ...
    public void clickedRepresentMajor(Button button) {
        currentCategory = SortEnums.MAJOR;
        legend.updateCategory(currentCategory);
        drawGlyphs();
    }
    ...
    public void clickedRepresentRegion(Button button) {
        currentCategory = SortEnums.REGION;
        legend.updateCategory(currentCategory);
        drawGlyphs();
    }
        ...
        for (int row = 0; row < 3; row++) {
            for (int col = 0; col < 3; col++) {
                ...
                if (index < songs.size()) {
                    ...
                    GlyphShape glyph = new GlyphShape(window, xcor, ycor, songs
